...
//        XCUIApplication().navigationBars["Create Account"].staticTexts["Create Account"].tap()
    ...
    func testProfile(){
        ...
        //profile.tap_Bio()
        profile.tap_Coach()
        var service = profile.fields_Coach.ServicesProvided()
        print(service)
        profile.fields_Coach.ServicesProvided(serviceslist: ["All","All","All"])//reset return none
        service = profile.fields_Coach.ServicesProvided()
        print(service)
...
//        profile.fields_Bio.FirstName(txt: "ZX")
//        profile.fields_Bio.LastName(txt: "XZ")
//        
